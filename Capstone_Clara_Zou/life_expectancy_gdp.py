...
#Chile, Germany, China, United States, Zimbabwe, Mexico
...
# "Life Expectancy Relative to GDP in the 21st Century"
...
#no, there is a large disparity between countries when comparing GDP across countries. A smaller disparity between the LEABY of countries
...
#China and the US had GDP change the most. Zimbabwe had the most change in GDP between 2000 and 2015
#2006 and 2015 had the biggest LEABY change for Zimbabwe especially. 2003-2006 had the biggest change in GDP.
#Zimbabwe had zero change and Chile had the least change in GDP over time
#Zimbabwe remains at the bottom in both country comparison charts. US shows the most optimistic LEABY and positive trend in GDP.
#LEABY rises with GDP, except Zimbabwe is the exception for GDP tracking with LEABY
#US is the most developed and a leading world leader, so it's logical that the GDP and LEABY data is a positive outlook. China has had great growth that drives GDP and LEABY. Zimbabwe is a developing country hence the data. THese countries and their data tracks with their reputation and world standing.
...
g = (g.map(plt.scatter,
           "GDP",
          "LEABY", 
           edgecolor="g").add_legend())
plt.savefig("Scatter_Plot_LEABY.png")
...
#the scatter plots are not easy to read. The data can be displayed in a more effective manner
...
g4 = (g4.map(plt.plot, "Year", "GDP", color="r").add_legend())
...
#Germany, Chile, and the US have the highest. Zimbabwe has the lowest
...
#China's trade increased dramatically and exports increased. GDP increased as a result
...
#created my blog post on Google docs
